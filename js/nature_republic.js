$(function () {
    ...
    // ----- visual
    function banner() {
        $(".circle>li").eq(num_banner).addClass("active").siblings("li").removeClass("active");
        $(".banner_main>li").eq(num_banner).stop().fadeIn(400).siblings("li").stop().fadeOut(400);
    }
